...
export const worldInteractions: WorldInteraction[] = [
  { id: "noticeboard-ground", floorId: "ground", position: { x: 520, y: 470 }, title: "Student noticeboard", prompt: "Read the board", description: "A rotating board of clubs and public events. Take a note, not a poster.", kind: "interaction" },
  ...
  { id: "gate-punch", floorId: "ground", position: { x: 1160, y: 1315 }, title: "Old punch gate", prompt: "Inspect the mechanism", description: "A retired entry mechanism now serves as a tiny piece of campus history.", kind: "discovery", discoveryId: "punch-gate-story", rewardXp: 15 },
  { id: "library-atlas", floorId: "fifth", position: { x: 780, y: 380 }, title: "Campus atlas", prompt: "Turn a page", description: "A fictional atlas invites you to compare what is documented with what you actually see.", kind: "interaction" },
  ...
  { id: "ics-parts-tray", floorId: "fourth", position: { x: 760, y: 360 }, title: "Parts tray", prompt: "Sort the tray", description: "A small maker ritual: label what you use so the next person can find it.", kind: "interaction" },
  { id: "ics-terminal", floorId: "fourth", position: { x: 1120, y: 440 }, title: "Unplugged terminal", prompt: "Read the note", description: "The note asks explorers to reproduce a problem before proposing a fix.", kind: "discovery", discoveryId: "terminal-note", rewardXp: 20 },
  { id: "admin-community-board", floorId: "second", position: { x: 1030, y: 520 }, title: "Community board", prompt: "Check the board", description: "A fictional list of volunteer shifts connects small acts to a bigger campus.", kind: "interaction" },
  ...
  { id: "support-water-station", floorId: "first", position: { x: 700, y: 790 }, title: "Water station", prompt: "Refill your plan", description: "A gentle reminder to take care of the explorer behind the avatar.", kind: "interaction" },
  { id: "support-notice", floorId: "first", position: { x: 940, y: 650 }, title: "Support notice", prompt: "Read the sign", description: "A fictional sign points toward respectful, private support conversations.", kind: "discovery", discoveryId: "support-note", rewardXp: 20 },
  { id: "roof-planter", floorId: "roof-deck", position: { x: 970, y: 470 }, title: "Roof planter", prompt: "Check the new leaf", description: "A public green-space story grows one careful observation at a time.", kind: "discovery", discoveryId: "first-leaf", rewardXp: 20 },
  { id: "third-gallery", floorId: "third", position: { x: 880, y: 480 }, title: "Gallery rail", prompt: "Follow the line", description: "A fictional student exhibition links sketches from several disciplines.", kind: "interaction" },
  { id: "sixth-study-nook", floorId: "sixth", position: { x: 820, y: 360 }, title: "Study nook", prompt: "Leave a kind note", description: "One sentence of encouragement can make a shared study space feel welcoming.", kind: "interaction" },
  { id: "seventh-rooftop-log", floorId: "seventh", position: { x: 1080, y: 410 }, title: "Weather log", prompt: "Add an observation", description: "A fictional weather log rewards careful attention to the everyday.", kind: "discovery", discoveryId: "weather-log", rewardXp: 20 },
...
export const hiddenDiscoveries: HiddenDiscovery[] = [
  { id: "punch-gate-story", title: "The punch gate story", description: "An old entry ritual became a welcome for every new explorer.", floorId: "ground", position: { x: 1160, y: 1315 }, set: "Campus traces", stamp: "TRACE-01", rewardXp: 15, interactionId: "gate-punch" },
  ...
  { id: "terminal-note", title: "The terminal note", description: "Reproduce, observe, then change one thing: a maker's pocket rule.", floorId: "fourth", position: { x: 1120, y: 440 }, set: "Campus traces", stamp: "TRACE-03", rewardXp: 20, interactionId: "ics-terminal" },
  ...
  { id: "support-note", title: "The support note", description: "A private invitation to ask for help without having to explain everything at once.", floorId: "first", position: { x: 940, y: 650 }, set: "People & places", stamp: "PEOPLE-02", rewardXp: 20, interactionId: "support-notice" },
  { id: "first-leaf", title: "The first leaf", description: "A new leaf marks the rooftop garden's fictional seasonal beginning.", floorId: "roof-deck", position: { x: 970, y: 470 }, set: "People & places", stamp: "PEOPLE-03", rewardXp: 20, interactionId: "roof-planter" },
  { id: "weather-log", title: "The weather log", description: "A careful note turns a passing sky into a shared campus record.", floorId: "seventh", position: { x: 1080, y: 410 }, set: "Campus traces", stamp: "TRACE-04", rewardXp: 20, interactionId: "seventh-rooftop-log" },
...
export const npcs: NPCDefinition[] = [
  ...
  { id: "rafi", name: "Rafi", role: "gardening club volunteer", floorId: "roof-deck", position: { x: 840, y: 470 }, bio: "Rafi keeps the fictional rooftop planters labelled and watered.", greeting: "A garden is a team sport: notice, share, and leave it better.", rumorIds: ["rooftop-garden"], questIds: ["green-route"], accent: "#8bc8a1" },
  ...
  { id: "sana", name: "Sana", role: "peer mentor", floorId: "first", position: { x: 820, y: 700 }, bio: "Sana helps students find a next step without taking over their choices.", greeting: "You can ask for directions, support, or simply a quiet minute.", rumorIds: [], questIds: ["open-door-route"], accent: "#d7a0cf" },
  { id: "javed", name: "Javed", role: "student council treasurer", floorId: "second", position: { x: 900, y: 560 }, bio: "Javed makes fictional club budgets readable and kind to first-time organisers.", greeting: "A good plan leaves room for the person who has not arrived yet.", rumorIds: [], questIds: ["shared-campus"], accent: "#eaa77b" },
  { id: "lina", name: "Lina", role: "library research fellow", floorId: "fifth", position: { x: 1010, y: 360 }, bio: "Lina keeps an atlas of questions, sources, and surprising connections.", greeting: "Bring me a question and one source you trust. We can follow the thread.", rumorIds: [], questIds: ["echoes-and-edges", "signal-to-story"], accent: "#b3a6e8" },
];
